...
public class PlatformStopException
    extends PlatformRuntimeException
    implements PlatformObject {
    
    private Platform platform;
    
    public PlatformStopException(Platform platform) {
        super(platform);
        
        this.platform = platform;
    }
    
    public PlatformStopException(Platform platform, Throwable cause) {
        super(platform, cause);
        
        this.platform = platform;
    }
    
    public PlatformStopException(Platform platform, String message) {
        super(platform, message);
        
        this.platform = platform;
    }
    
    public PlatformStopException(Platform platform, String message, Throwable cause) {
